...
describe('AgentDisconnectionNotification', () => {
  ...
  describe('Visibility and Rendering', () => {
    ...
    it('should not render when isVisible is false', () => {
      render(<AgentDisconnectionNotification {...defaultProps} isVisible={false} />);
    ...
    it('should display agent name in message when provided', () => {
      ...
      expect(screen.getByText(/John Smith has disconnected/)).toBeInTheDocument();
    });

    it('should display generic message when agent name is not provided', () => {
      render(<AgentDisconnectionNotification {...defaultProps} agentName={undefined} />);
  ...
  describe('Auto-hide Functionality', () => {
    ...
    it('should clear timer when component unmounts', () => {
      const { unmount } = render(<AgentDisconnectionNotification {...defaultProps} />);
  ...
  describe('Animation States', () => {
    it('should apply hiding class during dismiss animation', async () => {
      ...
      expect(document.querySelector('.agent-disconnection-notification--hiding')).toBeInTheDocument();
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle rapid show/hide cycles', async () => {
      ...
      rerender(<AgentDisconnectionNotification {...defaultProps} isVisible={false} />);
      rerender(<AgentDisconnectionNotification {...defaultProps} isVisible={true} />);
