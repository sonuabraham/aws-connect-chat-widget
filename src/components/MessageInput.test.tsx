...
describe('MessageInput', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render with custom placeholder', () => {
      render(
        <MessageInput {...defaultProps} placeholder="Custom placeholder" />
      );
  ...
  describe('Message Sending', () => {
    it('should send message on form submit', async () => {
      ...
      const user = userEvent.setup({ advanceTimers: vi.advanceTimersByTime });
      render(
        <MessageInput {...defaultProps} onSendMessage={mockOnSendMessage} />
      );
  ...
  describe('Edge Cases', () => {
    it('should handle undefined onSendMessage gracefully', async () => {
      const user = userEvent.setup({ advanceTimers: vi.advanceTimersByTime });
      render(
        <MessageInput {...defaultProps} onSendMessage={undefined as any} />
      );
