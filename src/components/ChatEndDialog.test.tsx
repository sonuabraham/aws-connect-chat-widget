...
describe('ChatEndDialog', () => {
  ...
  describe('Content Display', () => {
    ...
    it('should display confirmation message', () => {
      ...
      expect(screen.getByText('Are you sure you want to end this chat session?')).toBeInTheDocument();
  ...
  describe('Button Interactions', () => {
    ...
    it('should have proper button types', () => {
      ...
      expect(screen.getByText('Continue Chat')).toHaveAttribute('type', 'button');
  ...
  describe('Styling and Layout', () => {
    it('should apply correct CSS classes', () => {
      ...
      expect(document.querySelector('.chat-end-dialog-overlay')).toBeInTheDocument();
      expect(document.querySelector('.chat-end-dialog')).toBeInTheDocument();
      expect(document.querySelector('.chat-end-dialog__header')).toBeInTheDocument();
      expect(document.querySelector('.chat-end-dialog__content')).toBeInTheDocument();
      expect(document.querySelector('.chat-end-dialog__actions')).toBeInTheDocument();
    });
    ...
    it('should display stats in proper structure', () => {
      ...
      expect(document.querySelector('.chat-end-dialog__stats')).toBeInTheDocument();
  ...
  describe('Accessibility', () => {
    ...
    it('should handle keyboard interactions', () => {
      const mockOnConfirm = vi.fn();
      const mockOnCancel = vi.fn();
      render(<ChatEndDialog {...defaultProps} onConfirm={mockOnConfirm} onCancel={mockOnCancel} />);
  ...
  describe('Component State', () => {
    ...
    it('should handle rapid open/close cycles', () => {
      const { rerender } = render(<ChatEndDialog {...defaultProps} isOpen={false} />);
  ...
  describe('Performance', () => {
    it('should not render DOM elements when closed', () => {
      ...
      expect(document.querySelector('.chat-end-dialog-overlay')).not.toBeInTheDocument();
      expect(document.querySelector('.chat-end-dialog')).not.toBeInTheDocument();
    });
